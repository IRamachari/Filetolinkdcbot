...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_linkk = f"https://atglinks.com/api?api=={Var.API}&url={stream_link}"
        
        online_link = f"https://atglinks.com/api?api={Var.API}&url={Var.URL}{str(log_msg.message_id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
